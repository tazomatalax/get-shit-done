...
If the agent CAN do it via CLI/API/tool, the agent MUST do it.

Checkpoints are for:
- **Verification** - Human confirms the agent's work (visual, UX)
...
**Git commits = context engineering for the agent.**
...
See `~/.github/get-shit-done/references/git-integration.md` for complete strategy.
</atomic_commits>
...
- Sprint ceremonies
- Human dev time estimates (hours, days, weeks—the agent works differently)
