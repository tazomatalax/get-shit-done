...
- Codebase patterns (the agent reads the code)
- Technical risks (the agent identifies during research)
- Implementation constraints (the agent figures out)
- Success metrics (the agent infers from the work)
